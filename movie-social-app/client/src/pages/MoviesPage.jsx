...
const MoviesPage = () => {
  ...
  // Fetch movies based on category, genre, and language
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        ...
        switch (selectedCategory) {
          case 'discover':
            url = `https://api.themoviedb.org/3/discover/movie?${params.toString()}&sort_by=popularity.desc`;
            break;
          case 'trending':
    ...
    fetchMovies();
  }, [selectedCategory, selectedGenre, selectedLanguage, apiKey]);
