          ...
          <div className="space-y-6">
            {activeTab === 'activity' && (
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  {[1, 2, 3].map((item) => (
                    <div key={item} className="bg-gray-700/50 rounded-lg p-4 hover:bg-gray-700 transition-colors">
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between">
                            <h4 className="text-white font-medium">Movie Title {item}</h4>
                            <span className="text-gray-400 text-sm">2 hours ago</span>
                          </div>
                          <p className="text-gray-300 mt-1">Added to watchlist</p>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-300 mt-2 line-clamp-3">
                            This is a sample review for Movie {item}. The movie was excellent with great performances and an engaging storyline. The cinematography was stunning and the soundtrack was perfect for the mood of the film.
                          </p>
